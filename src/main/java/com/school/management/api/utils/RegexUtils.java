...
public class RegexUtils {
     ...
     * 正整数1-4
     */
    public static final String REGEX_INTEGER_POS_FOUR = "^[1-4|4]$";
     ...
     * 验证1-4整数
     */
    public static boolean check1To4Integer(String number) {
        return Pattern.matches(REGEX_INTEGER_POS_FOUR, number);
    }
